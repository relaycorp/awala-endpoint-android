...
internal class StorageImpl
    constructor(
        ...
        internal val gatewayId: SingleModule<String> =
            SingleModule(
                persistence = persistence,
                prefix = "gateway_id_",
                serializer = { address: String -> address.toByteArray(ascii) },
                deserializer = {
                        addressSerialized: ByteArray ->
                    addressSerialized.toString(ascii)
                },
            )

        internal val internetAddress: SingleModule<String> =
            SingleModule(
                persistence = persistence,
        ...
        internal val publicThirdParty: Module<PublicThirdPartyEndpointData> =
            Module(
                persistence = persistence,
        ...
        internal val privateThirdParty: Module<PrivateThirdPartyEndpointData> =
            Module(
                persistence = persistence,
