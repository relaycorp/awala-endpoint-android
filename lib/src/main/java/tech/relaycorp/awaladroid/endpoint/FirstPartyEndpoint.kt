...
public class FirstPartyEndpoint
    internal constructor(
        ...
        private suspend fun issueAuthorization(
            ...
            val sessionKeyPair =
                context.endpointManager.generateSessionKeyPair(
                    nodeId,
        ...
        public suspend fun authorizeIndefinitely(
            thirdPartyEndpoint: ThirdPartyEndpoint,
        ): ByteArray = authorizeIndefinitely(thirdPartyEndpoint.identityKey).auth
        ...
        internal suspend fun reRegister(): FirstPartyEndpoint {
            ...
            val registration =
                context.gatewayClient.registerEndpoint(
                    identityPrivateKey.toKeyPair(),
                )
            val newEndpoint =
                FirstPartyEndpoint(
                    identityPrivateKey,
        ...
        internal suspend fun reissuePDAs() {
            val context = Awala.getContextOrThrow()
            val thirdPartyEndpointAddresses =
                context.channelManager.getLinkedEndpointAddresses(
                    this,
                )
        ...
        public companion object {
            ...
            public suspend fun load(nodeId: String): FirstPartyEndpoint? {
                ...
                val internetAddress: String =
                    context.storage.internetAddress.get()
