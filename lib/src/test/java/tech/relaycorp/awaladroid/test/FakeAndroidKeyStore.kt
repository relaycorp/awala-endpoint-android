...
public object FakeAndroidKeyStore {
    ...
    public class FakeKeyStore : KeyStoreSpi() {
        ...
        ): Unit = wrapped.setKeyEntry(alias, key, password, chain)
        ...
        override fun engineStore(
            stream: OutputStream?,
            password: CharArray?,
        ): Unit = wrapped.store(stream, password)
        ...
        override fun engineLoad(
            stream: InputStream?,
            password: CharArray?,
        ): Unit = wrapped.load(stream, password)
        ...
        override fun engineSetCertificateEntry(
            alias: String?,
            cert: Certificate?,
        ): Unit = wrapped.setCertificateEntry(alias, cert)
