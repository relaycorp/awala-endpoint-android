...
internal class OutgoingMessageTest : MockContextTestCase() {
    ...
    @Test
    fun build_customExpiryDate() =
        runTest {
            val (senderEndpoint, recipientEndpoint) =
    ...
    @Test
    fun buildForPublicRecipient_checkBaseValues() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PUBLIC)
    ...
    @Test
    fun buildForPublicRecipient_checkServiceMessage() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PUBLIC)
            ...
            assertArrayEquals(
                MessageFactory.serviceMessage.content,
                serviceMessageDecrypted.content,
            )
        }

    @Test
    internal fun buildForPublicRecipient_checkSenderCertificate() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PUBLIC)
    ...
    @Test
    internal fun buildForPublicRecipient_checkSenderCertificateChain() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PUBLIC)
    ...
    @Test
    fun buildForPrivateRecipient_checkBaseValues() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PRIVATE)
            val message = MessageFactory.buildOutgoing(channel)
    ...
    @Test
    internal fun buildForPrivateRecipient_checkSenderCertificate() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PRIVATE)
    ...
    @Test
    internal fun buildForPrivateRecipient_checkSenderCertificateChain() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PRIVATE)
